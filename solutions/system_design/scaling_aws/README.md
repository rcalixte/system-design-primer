...
![High level design of an AWS service](http://i.imgur.com/B8LDKD7.png)
...
![Scaled design of an AWS service to lighten load on a single box and allow for independent scaling](http://i.imgur.com/rrfjMXB.png)
...
![Scaled design of an AWS service to address web server scaling](http://i.imgur.com/raoFTXM.png)
...
![Scaled design of an AWS service to address MySQL scaling](http://i.imgur.com/OZCxJr0.png)
...
![Scaled design of an AWS service with autoscaling added](http://i.imgur.com/3X8nmdL.png)
